...
<%@ page import="com.sc.JobApp.model.JobPost" %>
<%@ page import="com.sc.JobApp.repo.JobRepo" %>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav ms-auto">
                ...
                <li class="nav-item"><a class="nav-link" href="https://portfolio-flame-seven-68.vercel.app/">Contact</a></li>
            </ul>
        </div>
    </div>
</nav>
